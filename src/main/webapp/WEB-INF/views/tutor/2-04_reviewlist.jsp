...
<html lang="ko">
  <head>
    <!-- ======= HTML <head : CSS / Google Font / Favicons ======= -->
      ...
      <link href="/resources/css/2-03-04_tutorpage.css" rel="stylesheet">
    <!-- ========================================================= -->

    <title>튜터페이지-리뷰리스트</title>
         ...
         <div class="row">
          ...
          <div class="right-section col-9"> 
            <div class="headers d-flex flex-column"> 
              <div class="head-line"><h2><strong>학생리뷰</strong></h2></div>
              <div class="review-count text-end">후기 총00개</div>
            </div>
            ...
            <div class="review-block mt-5"><!-- 유저리뷰 전체 블락  -->
