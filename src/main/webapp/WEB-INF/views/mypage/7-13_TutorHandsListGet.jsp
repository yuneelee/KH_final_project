    ...
    <div class="row">
      ...
      <div id="nav" class="col-lg-3">
        ...
        <div class="list-group">
          <a href="/mypage//tutorPage" class="list-group-item list-group-item-action px-lg-4">기본 정보</a>
          <a href="/mypage/tutorHands/get" class="list-group-item list-group-item-action px-lg-4 fw-bold">손들기 내역</a>
      ...
      <div id="contents" class="col-lg-9">
        ...
        <!-- FROM -->
        <div class="my-3">
          <a href="/mypage/tutorHands/get" class="btn bg-blue">획득 내역</a>
